  ...
  return (
    <section className='flex md:flex-row flex-col px-4 py-10 items-center gap-12 container mx-auto'>
      ...
      <div className='md:py-10 md:w-1/2 text-left'>
        <h3 className='font-heading mb-12'>Chambre vedette</h3>

        <p className='font-normal max-w-md'>{featuredRoom.description.substring(0, 550)}...</p>

        <div className='flex flex-col md:flex-row md:items-end justify-between mt-5 gap-2'>
          <div className='flex mb-3 md:mb-0'>
            <div className='flex gap-3 flex-col items-center justify-center mr-4  border-r border-r-slate-300'>
              <p className='text-xs lg:text-xl text-center '>Prix à partir de {' '}</p>
              <p className='md:font-bold flex font-medium text-lg xl:text-5xl'>
                dt {featuredRoom.price} {'  '}
              </p>
            </div>
            <div className='flex gap-3 flex-col items-center justify-center mr-4'>
              <p className='text-xs lg:text-xl text-center'>Rabais</p>
              <p className='md:font-bold flex font-medium text-lg xl:text-5xl'>
                dt {featuredRoom.discount}
              </p>
            </div>
          </div>
